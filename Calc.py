...
ent_field = tk.Entry(root, bg='#404040', fg='#FFFFFF', font=('Arial', 25),
...
for j in range(2, 5):
    for k in range(3):
        button.append(tk.Button(root, text=numberpad[i], font=FONT,
                                fg="#FFFFFF", bg="#333333", width=6, height=2,
...
btn_CE = tk.Button(root, text='CE', command=lambda: sc_app.Clear_Entry(),
                   font=FONT, height=2, fg="#000000", bg="#FFA500",
                   highlightbackground='#000000', highlightthickness=2)
...
btn_pi = tk.Button(root, text='\u03C0', command=lambda: sc_app.Pi(),
                   font=FONT, width=5, height=2, fg="#000000", bg="#FFA500",
                   highlightbackground='#000000', highlightthickness=2)
